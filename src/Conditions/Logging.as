void NotifyWarn(const string &in msg) {
    UI::ShowNotification("CRP Helper", msg, vec4(1, .5, .1, .5), 6000);
}

void NotifyInfo(const string &in msg) {
    UI::ShowNotification("CRP Helper", msg, vec4(.2, .8, .5, .3), 6000);
}

void NotifyError(const string &in msg) {
    UI::ShowNotification("CRP Helper", msg, vec4(1, .2, .2, .3), 6000);
}
